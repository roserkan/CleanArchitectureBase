...
/// <summary>
/// Provides to filter the query of type IQueryable<T> and return the same type.
/// </summary>
public static class IQueryableDynamicFilterExtensions
{
    /// <summary>
    /// A dictionary containing string values of operators.
    /// </summary>
    ...
    /// <summary>
    /// Filters and returns data according to the specified filter.
    /// </summary>
