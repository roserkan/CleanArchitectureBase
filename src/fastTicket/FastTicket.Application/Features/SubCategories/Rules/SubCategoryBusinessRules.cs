...
using static FastTicket.Application.Features.SubCategories.Constants.Messages;
...
public class SubCategoryBusinessRules
{
    ...
    public async Task MakeSureYouHaveASubCategory(Guid id)
    {
        ...
        if (result is null) throw new BusinessException(SubCategory_NotFound);
    }
    ...
    public async Task SubCategoryIdShouldExist(Guid id)
    {
        ...
        if (result == null) throw new BusinessException(SubCategory_NotFound);
    }
